...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-200 p-4">
        <div class="lg:w-1/2 mx-auto py-8 px-6 bg-white rounded-xl">
            <h1 class="font-bold text-5xl text-center mb-8">My Todo List</h1>
                    ...
                    >
                        ...
                        <div class="flex space-x-3">
                            <form method="POST" action="/{{ $todo->id }}">
                                ...
                                <button class="py-2 px-2 bg-green-500 text-white flex items-center rounded-xl">
                            ...
                            <form method="POST" action="/{{ $todo->id }}">
                                ...
                                <button class="py-2 px-2 bg-red-500 text-white flex items-center rounded-xl">
